        ...
        <div class="mb-3 mb-lg-0">
          <h1 class="h4 media align-items-center text-dark">
            <div class="media-body">
              {{$t('common.token')}}
              <span class="text-secondary small">{{tokenDetail.symbol}}</span>
            </div>
          </h1>
        </div>
      </div>
            ...
            <div class="card-body">
              <div class="row align-items-center">
                ...
                <div class="col-md-8 font-weight-medium">
                  <value-format className="text-dark font-size-3 text-break w-100 text-left" :unitCurrency="tokenDetail.symbol"  :value="tokenDetail.totalSupply||'0'"></value-format>
                </div>
              </div>
              <div>
                <hr class="hr-space">
        ...
        <div class="col-md-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <hr class="hr-space">
                <div class="row align-items-center">
                  <div class="col-md-4 mb-1 mb-md-0">{{$t('token.decimals')}}:</div>
                  <div class="col-md-8">
        ...
        <div class="card-body">
          <div class="row mx-gutters-md-1">
            ...
            <div class="col-md">
              ...
              <value-format className="text-dark font-size-3 text-break w-100 text-left" :unitCurrency="tokenDetail.symbol"  :value="balance||'0'"></value-format>
            </div>
          </div>
        </div>
      </div>
