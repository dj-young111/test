    ...
    <div class="container">
      <div class="list-title">
        <h1 class="h4 font-weight-normal mb-0">
          ...
          <a class="u-label u-label--xs u-label--secondary rounded color-strong ml-2">HRC-20</a>
        </h1>
      </div>
    </div>
    <div class="container">
...
<script>
  ...
  export default {
    ...
    methods: {
      getData(pageNo) {
        this.loading = true;
        const params = { pageSize: this.pageSize, pageNo: pageNo || this.pageNo, type: 3 };
      ...
      onChange(i) {
        this.pageNo = i;
        this.getData(i);
        this.$router.push({ path: '/tokentxns/' + this.pageSize + '/' + i, query: { ...this.$route.query }});
      },
      selectFn(e) {
        this.pageSize = e.target.value;
        this.pageNo = 1;
        this.getData();
        this.$router.push({ path: '/tokentxns/' + this.pageSize + '/' + this.pageNo, query: { ...this.$route.query }});
      },
      switchTime() {
