          ...
          <div class="card h-100">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="btn btn-xs btn-soft-secondary btn-status py-1 px-2"><strong
                  class=" text-right">{{totalIncoming}} HT</strong> </span></div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="table-responsive mb-2 mb-md-0">
            <table class="table table-hover">
              ...
              <tr v-else v-for="(item,index) in list" :key="index">
                ...
                <td>
                  <value-format className="text-dark font-size-3" :unitCurrency="'HT'" :value="item.incomeHT ? String(item.incomeHT): '0'"></value-format>
                </td>
              </tr>
              </tbody>
            </table>
