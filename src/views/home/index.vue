        ...
        <div class="card-body">
          <div class="row mx-gutters-md-1">
            <div class="col-md-6 col-lg-6 card-divider">
              ...
              <div class="card-top-item">
                <div class="avatar">
                  <img src="../../images/market.svg" alt="Market Cap" />
                </div>
                <div>
                  <h2 class="font-size-1 text-uppercase text-secondary">
                    {{$t('home.content2')}}
            ...
            <div class="col-md-6 col-lg-6">
              <div class="card-top-item">
                <div class="avatar">
                  <img src="../../images/latest.svg" :alt="$t('home.content3')" />
                </div>
                <div style="flex: 1">
                  <h2 class="font-size-1 text-uppercase text-secondary">
                    {{$t('home.content3')}}
              ...
              <div class="card-top-item">
                <figure class="avatar">
                  <img src="../../images/active.svg" alt="SVG" />
                </figure>
                <div style="flex: 1">
                  <h2 class="font-size-1 text-uppercase text-secondary">
                    {{$t('home.content5')}}
                          ...
                          <div class="d-sm-flex justify-content-between">
                            <div class="text-nowrap mr-4 mb-1 mb-sm-0">
                              ...
                              <span class="d-sm-block"
                                >{{$t('home.to')}}
                                <el-tooltip class="item" effect="dark" :content="item.to" placement="top">
                              <el-button type="text" class="font-weight-normal font-size-3" style="padding: 0;color: #3F7FFF;">
                               <a :href="'/address/'+item.to" class="hash-tag text-truncate">{{item.to}}</a>
                              </el-button>
                            </el-tooltip>
                              </span>
                            </div>
