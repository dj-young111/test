          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-8">
                  <value-format currency="$" className="text-dark font-size-3 text-break w-100 text-left" :value="addressData.htValue||'0'"></value-format>
                        ...
                        <div
                          ...
                          <div style="max-height: none;" tabindex="0">
                            <div style="position:relative; top:0; left:0;">
                              <div class="list-not-found text-center pt-5" v-show="assetSearch.length<=0">
                                  ...
                                  <a
                                    ...
                                    <div>
                                      <div class="d-flex align-items-center">
                                        ...
                                        <value-format className=" list-amount link-hover__item font-size-3 text-break w-100 text-left" :unitCurrency="item.symbol" :value="item.value||'0'"></value-format>
                                    </div>
                                  </a>
                                </li>
                              </ul>
      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center p-0">
          <ul class="nav nav-custom nav-borderless nav_tabs1" id="nav_tabs" role="tablist">
            ...
            <li class="nav-item" v-show="status>1">
              <a class="nav-link" :class="hash === 'contracts'?'active':''" href="#contracts"
                 data-toggle="tab" @click="tabFuc('#contracts')">
        ...
        <div class="card-body">
          ...
          <div class="tab-content" v-show="!pageLoading">
            ...
            <div class="tab-pane fade in" :class="hash === 'contracts'?'show active':''" id="contracts" visible="false" style="min-height:300px">
              <div class="tab-pane fade active show" id="code" style="display:visible;">
                ...
                <div id="dividcode">
                  <div class="mb-4" v-show="contractDetail.openSource===1">
                    ...
                    <div v-for="(item, index) in contractDetail.code" :key="index">
                      ...
                      <pre class="editor ace_editor ace-dawn" id="editor" style="margin-top: 5px; height: 400px">
                      {{item.code}}
                      </pre>
                      <br>
                    </div>
  ...
  export default {
      ...
      getAddressType({ address }).then(res => {
        if (res.status === 1) {
          ...
          if (res.data > 1) {
            ...
            getAddressContractDetails({ address }).then(response => {
    ...
    methods: {
      ...
      toggleFullScreen() {
        ...
        if (this.expand) {
          $('#editor').height('100%'); // eslint-disable-line
          const editor = ace.edit('editor'); // eslint-disable-line
          editor.setOptions({
            maxLines: Infinity
          });
        } else {
          $('#editor').height('350px'); // eslint-disable-line
          const editor = ace.edit('editor'); // eslint-disable-line
          editor.setOptions({
            maxLines: 25
          });
      ...
      searchFuc(e) {
        ...
        this.assetSearch = this.assetList.filter((value) => { // 过滤数组元素
