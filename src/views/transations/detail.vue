            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  ...
                  <span v-else-if="txData.accountType===2">
                        ...
                        <li class="media align-items-baseline mb-2" v-for="(item,index) in txData.tokenTxes"
                          ...
                          <div class="media-body">
                            ...
                            <span class="hash-tag text-truncate  mr-1">
                                  <el-tooltip
                                    :content="item.tokenFrom"
                                    placement="top" effect="dark">
                                    <el-button type="text">
                                        <a :href="'/token/'+item.tokenAddress+'/25/1?a='+item.tokenFrom">
                            ...
                            <span class="hash-tag text-truncate ">
                                <el-tooltip
                                  :content="item.tokenTo"
                                  placement="top" effect="dark">
                                    <el-button type="text">
                                        <a :href="'/token/'+item.tokenAddress+'/25/1?a='+item.tokenTo">
